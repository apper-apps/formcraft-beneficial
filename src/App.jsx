...
return (
    <BrowserRouter>
<div className="min-h-screen bg-background dark:bg-gradient-to-br dark:from-dark-900 dark:via-dark-800 dark:to-dark-900 transition-colors duration-300" style={{ 
