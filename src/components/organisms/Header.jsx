...
const navigate = useNavigate();
  ...
  return (
<header
className="h-14 bg-gradient-to-r from-white via-gray-50 to-white dark:from-dark-900/70 dark:via-dark-800/80 dark:to-dark-900/70 shadow-lg border-b border-gray-200 dark:border-primary-500/30 px-6 transition-all duration-300 ease-out backdrop-blur-lg fixed top-0 left-0 right-0 z-50">
